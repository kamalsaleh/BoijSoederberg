...
##  one line.
	Subtitle := "A test package by kamal saleh",
...
Persons := [
  rec(
    ...
    IsAuthor      := true,
    IsMaintainer  := true,
    Email         := "kamal@momo.math.rwth-aachen.de",
    WWWHome       := "",
...
PackageDoc := rec(
  # use same as in GAP            
  BookName  := "Boij-Soederberg theory",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.10.05" ], [ "GAPDoc", ">= 1.0" ] ],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  BoijSoederberg ", ~.Version , "\n",
